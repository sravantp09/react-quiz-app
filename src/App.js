...
const quizTime = 600; // total quiz time in seconds
...
export default function App() {
  ...
  const { questions, status, index, answer, score, highScore, timeRemaining } =
      ...
      <Main>
        ...
        {status === "active" && (
          <>
            ...
            />
            <Footer>
              <Timer time={timeRemaining} dispatch={dispatch} />
              {/* Next Button */}
              {answer !== null && (
                <Button
                  index={index}
